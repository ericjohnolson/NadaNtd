...
INSERT INTO SurveyIndicators (SurveyTypeId, DataTypeId, DisplayName, AggTypeId, SortOrder, UpdatedById, UpdatedAt, IsDisabled, IsEditable, IsRequired, IsDisplayed, IsCalculated, CanAddValues, RedistrictRuleId, MergeRuleId) VALUES (17, 6, 'SchMappingTypeOfSite',4,55, 26, NOW(), 0, 0, 0, 0,0,0,2,54);
...
INSERT INTO SurveyIndicators (SurveyTypeId, DataTypeId, DisplayName, AggTypeId, SortOrder, UpdatedById, UpdatedAt, IsDisabled, IsEditable, IsRequired, IsDisplayed, IsCalculated, CanAddValues, RedistrictRuleId, MergeRuleId) VALUES (11, 6, 'SchSentinelTypeSite',4,45, 26, NOW(), 0, 0, 0, 0,0,0,2,54);

UPDATE SurveyIndicators SET SortOrder = SortOrder * 10 WHERE SurveyTypeId = 18;
INSERT INTO SurveyIndicators (SurveyTypeId, DataTypeId, DisplayName, AggTypeId, SortOrder, UpdatedById, UpdatedAt, IsDisabled, IsEditable, IsRequired, IsDisplayed, IsCalculated, CanAddValues, RedistrictRuleId, MergeRuleId) VALUES (18, 6, 'SthMappingTypeSite',4,55, 26, NOW(), 0, 0, 0, 0,0,0,2,54);
...
INSERT INTO SurveyIndicators (SurveyTypeId, DataTypeId, DisplayName, AggTypeId, SortOrder, UpdatedById, UpdatedAt, IsDisabled, IsEditable, IsRequired, IsDisplayed, IsCalculated, CanAddValues, RedistrictRuleId, MergeRuleId) VALUES (12, 6, 'SthSpotCheckTypeSite',4,45, 26, NOW(), 0, 0, 0, 0,0,0,2,54);
